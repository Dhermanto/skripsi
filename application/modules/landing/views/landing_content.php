<div class="card">
		...
		<div class="col-xs-12 col-sm-5">
			<form method="post" action="<?php echo $search_url; ?>">
				<div class="input-group search-group">
					<input type="text" name="keyword" class="form-control" placeholder="Search category" value="<?php echo $keyword; ?>">
	...
	<div class="my-actions">
		<a href="<?php echo $addnew_url; ?>"><button type="button" class="btn btn-primary btn-sm"><i class="zmdi zmdi-plus"></i> &nbsp; Add New Content</button></a> &nbsp;
		...
		<div class="modal-content">
			<form method="post" action="<?php echo $filter_url; ?>" class="form-horizontal">
				<div class="modal-header">
					...
					<h4 class="modal-title">Content Filter</h4>
				</div>
