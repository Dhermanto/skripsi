<div class="card">
		...
		<div class="col-xs-12 col-sm-5">
			<form method="post" action="<?php echo $search_url; ?>">
				<div class="input-group search-group">
					<input type="text" name="keyword" class="form-control" placeholder="Search trx no..." value="<?php echo $keyword; ?>">
	...
	<div class="my-actions">
		<a href="<?php echo $addnew_url; ?>"><button type="button" class="btn btn-primary btn-sm"><i class="zmdi zmdi-plus"></i> &nbsp;Add Credit Points</button></a> &nbsp;
		...
		<div class="modal-content">
			<form method="post" action="<?php echo $filter_url; ?>" class="form-horizontal">
				<div class="modal-header">
					...
					<h4 class="modal-title">Credits Points Filter</h4>
				</div>
						...
						<div class="col-sm-7">
							<div>
								<select name="customer_id" class="chosen">
									...
									<?php echo modules::run('lookup/filter_credit', $filter['id']); ?>
								</select>
							</div>
						</div>
					</div>
