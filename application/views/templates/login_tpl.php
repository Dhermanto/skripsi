<!DOCTYPE html>
    ...
    <body class="login-content">
        ...
        <div class="lc-block toggled" id="l-login">
			<center><img src="<?php echo base_url('/img/iim-logo.png'); ?>" class="img-responsive" align="center"></center><br>
			<!-- <h3 style="color:IndianRed;margin-bottom:30px;margin-top:0;">iLearn - IIM Center</h3> -->
			<form method="post" action="<?php echo $login_url; ?>">
				<div class="input-group m-b-20">
					<span class="input-group-addon"><i class="zmdi zmdi-email"></i></span>
                    <?php echo $this->session->flashdata('name'); ?>
					<div class="fg-line">
						<input type="text" name="nama_login" class="form-control" placeholder="User ID" required>
					</div>
				</div>
		...
		<div class="lc-block" id="l-register">
			<form method="post" action="<?php echo $signup_url; ?>">
				<div class="input-group m-b-20">
				...
				<div class="input-group m-b-20">
					...
					<div class="fg-line">
						<input type="text" name="sektor_bisnis" class="form-control" placeholder="Sektor Bisnis" required>
					</div>
				</div>
				...
				<div class="checkbox">
					<label>
						...
						Dengan ini saya menyatakan bahwa data yang dimasukkan adalah benar
					</label>
				</div>
        ...
        <div class="lc-block" id="l-forget-password">
            <p class="text-left">Mohon masukkan alamat email Anda. Kami akan mengirimkan link untuk mengubah password Anda. Terima kasih.</p>
